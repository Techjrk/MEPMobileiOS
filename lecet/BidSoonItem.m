...
#define BID_SOON_ITEMVIEW_LABEL_TEXT_COLOR                   RGB(255, 255, 255)
#define BID_SOON_ITEMVIEW_LABEL_BIDSERVICE_COLOR             RGB(34, 34, 34)
#define BID_SOON_ITEMVIEW_LABEL_BIDINFO_COLOR                RGB(159, 164, 166)

#define BID_SOON_ITEMVIEW_LABEL_DATE_FONT                    fontNameWithSize(FONT_NAME_LATO_REGULAR, 11)
#define BID_SOON_ITEMVIEW_LABEL_TIME_FONT                    fontNameWithSize(FONT_NAME_LATO_REGULAR, 11)
#define BID_SOON_ITEMVIEW_LABEL_BIDNAME_FONT                 fontNameWithSize(FONT_NAME_LATO_SEMIBOLD, 11)
#define BID_SOON_ITEMVIEW_LABEL_BIDSERVICE_FONT              fontNameWithSize(FONT_NAME_LATO_REGULAR, 12)
#define BID_SOON_ITEMVIEW_LABEL_BIDINFO_FONT                 fontNameWithSize(FONT_NAME_LATO_REGULAR, 10)
...
- (void)setItemInfo:(id)info {
    ...
    _labelBidType.text = [item getProjectType];
