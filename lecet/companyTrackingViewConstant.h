...
#ifndef companyTrackingViewConstant_h
#define companyTrackingViewConstant_h
...
#define COMPANYTRACKINGVIEW_BUTTON_LABEL_FONT                 fontNameWithSize(FONT_NAME_LATO_REGULAR, 12)
...
#endif /* companyTrackingViewConstant_h */
