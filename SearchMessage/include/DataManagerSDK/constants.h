...
#define NOTIFICATION_GPS_LOCATION_NEAR           @"NOTIFICATION_GPS_LOCATION_NEAR"
...
#define NOTIFICATION_SHOW_PROJECT                @"NOTIFICATION_SHOW_PROJECT"
#define NOTIFICATION_SIRI_EVENT                  @"NOTIFICATION_SIRI_EVENT"
...
#define SEARCH_RESULT_COMPANY_URL                @"SEARCH_RESULT_COMPANY_URL"
#define SEARCH_RESULT_COMPANY_FILTER             @"SEARCH_RESULT_COMPANY_FILTER"

#define SEARCH_RESULT_CONTACT                    @"SEARCH_RESULT_CONTACT"
#define SEARCH_RESULT_CONTACT_URL                @"SEARCH_RESULT_CONTACT_URL"
